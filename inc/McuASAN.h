...
void __asan_ReportGenericError(uint32_t ra, const char* typ);
__attribute__((__noreturn__))
void __asan_NOT_IMPL(uint32_t ra, const char* typ);
__attribute__((__noreturn__))
void __asan_ReportError(uint32_t ra, const char* typ, void *address, size_t kAccessSize, rw_mode_e mode);
